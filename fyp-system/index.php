...
<nav class="navbar">
    <div class="nav-container">
        ...
        <div class="nav-section">
            <div class="nav-links">
                <a href="./index.php" class="nav-link active" id="homeLink">Home</a>
                ...
                <a href="./pages/communication/communication-page.php" class="nav-link" id="communicationLink">Communication</a>
                <a href="./pages/profile/profile-page.php" class="nav-link" id="profileLink">Profile</a>
                <a href="./pages/login/login-page.php" class="nav-link" id="loginBtn">Login</a>
                <a href="./pages/register/register-page.php" class="nav-link" id="registerBtn">Register</a>
            </div>
        </div>
    </div>
</nav>
